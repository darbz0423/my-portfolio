    ...
    >
      ...
      <div
        className="
          ...
          gap-14 lg:grid-cols-[1.15fr_.85fr]
          lg:gap-20
        "
      >
        <div className="text-center lg:text-left">
          ...
          <p
            className="
              mx-auto mt-5 max-w-[580px]
              text-base leading-8
              text-[var(--secondary)]
              lg:mx-0
            "
          >
            I'm an IT student who enjoys
            building websites, experimenting
            with designs, and learning more
            about frontend development through
            actual projects.
          </p>
